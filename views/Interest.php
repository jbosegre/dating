        ...
        <figcaption>
            ...
            <form action="Profile_Summary.php" method="post">
                <fieldset>
                    ...
                    <div class="form-group ml-lg-2">
                        <label class="d-block" id="InputTitle7">Outdoor Activities</label>
                        <div class="form-check form-check-inline ml-5">
                            <label class="form-check-label">
                        ...
                        <!--<a href="http://jbose.greenriverdev.com/IT328_2019/dating/Profile_Summary"></a>-->
                            <button class="btn btn-primary" name="submit" type="submit" id="adjustButton">Next</button>
                </fieldset>
            </form>
        </figcaption>
    </figure>
